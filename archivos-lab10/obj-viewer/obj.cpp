...
static GLfloat light0_position [] = {10.0,10.0,10.0,0.0};
...
float rotY_direction = 0.0f, rotX_direction = 0.0f, strife = 0, transY_direction = 0, transZ_direction = 0.0f;
float speed_factor = 1;
glm::mat4 transforms[MODE_LAST];
int last_ticks = 0;
float cuy_x=0.0f, cuy_y=0.0f, cuy_z=0.0f;
float a, b, c, d, e, f;
...
Mesh ground, main_object, light_bbox, secondary_object, tercer_object, cuarto_object, five_object, six_object;
...
int init_resources(char* model_filename,char* model_filename2, char* model_filename3,char* model_filename4,char* model_filename5,char* model_filename6,char* vshader_filename, char* fshader_filename)
{
  load_obj(model_filename, &main_object);
  load_obj(model_filename2, &secondary_object);
  load_obj(model_filename3, &tercer_object);
  load_obj(model_filename4, &cuarto_object);
  load_obj(model_filename5, &five_object);
  load_obj(model_filename6, &six_object);
  ...
  glm::vec3 light_position = glm::vec3(0.0, 10.0, 15.0);
  light_bbox.vertices.push_back(glm::vec4(-10.1, -10.1, -10.1, 10.0));
  light_bbox.vertices.push_back(glm::vec4( 10.1, -10.1, -10.1, 10.0));
  light_bbox.vertices.push_back(glm::vec4( 10.1,  10.1, -10.1, 10.0));
  light_bbox.vertices.push_back(glm::vec4(-10.1,  10.1, -10.1, 10.0));
  light_bbox.vertices.push_back(glm::vec4(-10.1, -10.1,  10.1, 10.0));
  ...
  ground.upload();
  light_bbox.upload();
  secondary_object.upload();
  tercer_object.upload();
  cuarto_object.upload();
  five_object.upload();
  six_object.upload();
...
void init_view() {
  ...
  //secondary_object.object2world = glm::mat4(1);
  //tercer_object.object2world = glm::mat4(1);
	//cuarto_object.object2world = glm::mat4(1);
	//five_object.object2world = glm::mat4(1);
	//six_object.object2world = glm::mat4(1);
  transforms[MODE_CAMERA] = glm::lookAt(
	...
	//Cuy
	main_object.object2world = glm::translate(main_object.object2world, glm::vec3(27.0, -2.0, 15.0));
	main_object.object2world = glm::rotate(main_object.object2world, glm::radians(90.0f), glm::vec3(0.0, 1.0, 0.0));

	//gato1
	//tercer_object.object2world = glm::translate(tercer_object.object2world, glm::vec3(-16.0, -3.0, 13.0));

	//gato2
	//six_object.object2world = glm::translate(six_object.object2world, glm::vec3(-10.0, -3.0, 13.0));

	//Laberinto1
	secondary_object.object2world = glm::translate(secondary_object.object2world, glm::vec3(0.0, -4.0, 0.0));

	//Laberinto2
	five_object.object2world = glm::translate(five_object.object2world, glm::vec3(0.0, -4.0, 0.0));

	//alfalfa
	//cuarto_object.object2world = glm::translate(cuarto_object.object2world, glm::vec3(-16.0, -3.0, -16.0));

	srand(time(NULL));
	if(opcion == 1){
	secondary_object.object2world = glm::translate(secondary_object.object2world, glm::vec3(0.0, -4.0, 0.0));
	tercer_object.object2world = glm::translate(tercer_object.object2world, glm::vec3(a, -3.0,b));
	six_object.object2world = glm::translate(six_object.object2world, glm::vec3(c, -3.0, d));
	cuarto_object.object2world = glm::translate(cuarto_object.object2world, glm::vec3(e, -3.0, f));
	}
	if(opcion == 2){
	five_object.object2world = glm::translate(five_object.object2world, glm::vec3(0.0, -4.0, 0.0));
	tercer_object.object2world = glm::translate(tercer_object.object2world, glm::vec3(rand()%34-17, -3.0,rand()%34-17));
	six_object.object2world = glm::translate(six_object.object2world, glm::vec3(rand()%34-17, -3.0, rand()%34-17));
	cuarto_object.object2world = glm::translate(cuarto_object.object2world, glm::vec3(rand()%34-17, -3.0, rand()%34-17));
